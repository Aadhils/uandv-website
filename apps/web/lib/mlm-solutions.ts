...
export const mlmFaqs = [
  ...
  },
  {
    ...
    answer:
      'Yes. We review clarity, edge cases, payout load implications, and operational complexity before recommending build or redesign work.',
  },
  {
    question: 'Do you provide legal advice for MLM businesses?',
    answer:
      'We provide practical legal-readiness guidance and documentation checklists. We are not a law firm and do not replace licensed legal counsel in your markets.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Wallet balances, withdrawal requests, and approval workflows are designed so finance and admin teams retain control while members see clear statuses.',
  },
  {
    question: 'Can you integrate payment gateways?',
    answer:
      'Yes. Payment integrations are planned around your operating countries, settlement needs, and compliance requirements.',
  },
  {
    question: 'How do you approach KYC?',
    answer:
      'KYC flows capture verification status and documents according to your policy so onboarding and withdrawals can follow controlled rules.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes. Transactional messaging can be wired for critical events where SMS or WhatsApp is part of your member communication model.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes. Growth services can include website, apps, branding, SEO, digital marketing, CRM, ERP, AI automation, and training alongside the MLM platform.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'In many cases yes. Migration scope depends on data quality, genealogy integrity, wallet history, and how cleanly the old plan can be mapped.',
  },
  {
