...
import { VendorShell } from '@/components/vendor';

export const metadata: Metadata = {
  title: {
    default: 'Vendor Workspace',
    template: '%s · Vendor Workspace · U&V',
  },
  description:
    'U&V Vendor Workspace — assigned work, deliverables, invoices, and payments. Demo UI only.',
